...
public class LevelsSettings {
	...
	static public string[] m_BackgroundSpriteNames = {"back3", "back4", "back2", "back1",
		...
		"back3", "back3", "back3", "back3"};
	
	//	private members --------------------------

	static float[] m_HeadEatMassPerSecond = {2.0f, 3.0f, 4.0f, 6.0f, 8.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f};
	static float[] m_DeltaSpawnMove = {6.0f, 10.0f, 10.0f, 10.0f, 10.0f, 11.0f, 12.0f, 13.0f, 13.0f, 13.0f, 13.0f, 13.0f};
	static float[] m_DeltaFireballTime = {8.0f, 10.0f, 10.0f, 10.0f, 10.0f, 11.0f, 12.0f, 13.0f, 13.0f, 13.0f, 13.0f, 13.0f};
	static float[] m_VaseFallingAccelerationCoef = {1.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f};
	...
	static int[] m_MaxTime = {100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100};
}
